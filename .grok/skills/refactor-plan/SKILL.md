---
name: refactor-plan
description: "Generate detailed execution plan from analysis (Use when the user runs /refactor-plan.)"
---

# /refactor:plan

SD003 custom command `/refactor:plan` を Grok skill として再現します。
