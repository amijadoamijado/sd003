...
description: Codex equivalent of the SD003 custom command `/cleanup:restore`. Use when the user invokes `/cleanup:restore`, `cleanup-restore`.
---

# /cleanup:restore

この skill は Claude Code の `/cleanup:restore` を Codex で再現するためのものです。
