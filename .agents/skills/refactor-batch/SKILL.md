---
name: refactor-batch
description: Codex equivalent of the SD003 custom command `/refactor:batch`. Use when the user invokes `/refactor:batch`, `refactor-batch`.
---

# /refactor:batch

この skill は Claude Code の `/refactor:batch` を Codex で再現するためのものです。
