...
description: "Complete refactoring session and record final state (Use when the user runs /refactor-complete.)"
---

# /refactor:complete

SD003 custom command `/refactor:complete` を Grok skill として再現します。
