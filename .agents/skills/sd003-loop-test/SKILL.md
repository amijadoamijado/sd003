...
description: Codex equivalent of the SD003 custom command `/sd003:loop-test`. Use when the user invokes `/sd003:loop-test`, `sd003-loop-test`.
---

# /sd003:loop-test - Test Completion Loop

この skill は Claude Code の `/sd003:loop-test` を Codex で再現するためのものです。
