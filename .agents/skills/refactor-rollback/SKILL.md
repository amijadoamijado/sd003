...
description: Codex equivalent of the SD003 custom command `/refactor:rollback`. Use when the user invokes `/refactor:rollback`, `refactor-rollback`.
---

# /refactor:rollback

この skill は Claude Code の `/refactor:rollback` を Codex で再現するためのものです。
