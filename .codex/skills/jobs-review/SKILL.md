---
name: jobs-review
description: Codex equivalent of the SD003 custom command `/jobs-review`. Use when the user invokes `/jobs-review`, `jobs-review`.
---

# Jobs Review

この skill は Claude Code の `/jobs-review` を Codex で再現するためのものです。
...
Read and follow `.claude/skills/jobs-review/SKILL.md`.
