---
name: bug-quick
description: Codex equivalent of the SD003 custom command `/bug-quick`. Use when the user invokes `/bug-quick`, `bug-quick`.
---

# Bug QUICK - Processing Flow Comparison v1.0

この skill は Claude Code の `/bug-quick` を Codex で再現するためのものです。
