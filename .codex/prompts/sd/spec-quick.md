...
6. **Output Progress**:
   ```
   ✅ Spec initialized at .sd/specs/{feature-name}/
   ```
...
```
✅ Spec initialized at .sd/specs/{feature}/
✅ Requirements generated → Continuing to design...
✅ Design generated → Continuing to tasks...
```
...
/sd:spec-init → /sd:spec-requirements → /sd:validate-gap
→ /sd:spec-design → /sd:validate-design → /sd:spec-tasks
```
