...
## 旧バックアップの自動pruning（必須・Phase 6）

`--execute` のたびに `.sd003-backup-*` / `.sd003-upgrade-backup-*` は増え続け、`.sd002-backup-*`
（旧世代の残骸）も含めて無条件に堆積する（2026-07-05の D:\claudecode 全体整理で cf001 に8個堆積して
