...
description: "/ralph-wiggum:status - Execution Status (Use when the user runs /ralph-wiggum-status.)"
---

# /ralph-wiggum:status - Execution Status

SD003 custom command `/ralph-wiggum:status` を Grok skill として再現します。
