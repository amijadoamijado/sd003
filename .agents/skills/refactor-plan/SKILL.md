---
name: refactor-plan
description: Codex equivalent of the SD003 custom command `/refactor:plan`. Use when the user invokes `/refactor:plan`, `refactor-plan`.
---

# /refactor:plan

この skill は Claude Code の `/refactor:plan` を Codex で再現するためのものです。
