---
name: grillme
description: Codex equivalent of the SD003 custom command `/grillme`. Use when the user invokes `/grillme`, `grillme`.
---

# Grillme

この skill は Claude Code の `/grillme` を Codex で再現するためのものです。
...
Read and follow `.claude/skills/grillme/SKILL.md`.
