...
description: Codex equivalent of the SD003 custom command `/refactor:complete`. Use when the user invokes `/refactor:complete`, `refactor-complete`.
---

# /refactor:complete

この skill は Claude Code の `/refactor:complete` を Codex で再現するためのものです。
