---
name: cleanup
description: "AI judgment-based project cleanup (materials organization + temp file archive) (Use when the user runs /cleanup.)"
---

# /cleanup

SD003 custom command `/src/**,` を Grok skill として再現します。
