...
description: Codex equivalent of the SD003 custom command `/workflow:status`. Use when the user invokes `/workflow:status`, `workflow-status`.
---

# 工程状況: /workflow:status

この skill は Claude Code の `/workflow:status` を Codex で再現するためのものです。
