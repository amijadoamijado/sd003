---
name: refactor-batch
description: "Execute refactoring in batched files with auto-checkpoint (Use when the user runs /refactor-batch.)"
---

# /refactor:batch

SD003 custom command `/refactor:batch` を Grok skill として再現します。
