...
description: Codex equivalent of the SD003 custom command `/workflow:review`. Use when the user invokes `/workflow:review`, `workflow-review`.
---

# レビュー依頼: /workflow:review

この skill は Claude Code の `/workflow:review` を Codex で再現するためのものです。
