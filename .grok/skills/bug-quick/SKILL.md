---
name: bug-quick
description: "Bug QUICK - Processing flow comparison debugging (5-15 min first pass) (Use when the user runs /bug-quick.)"
---

# Bug QUICK - Processing Flow Comparison v1.0

SD003 custom command `/bug-quick` を Grok skill として再現します。
