---
name: workflow-impl
description: "AI協調ワークフロー - Antigravity(agy)/Codex実装実行（指示書→実行→復元を一括） (Use when the user runs /workflow-impl.)"
---

# 実装実行: /workflow:impl

SD003 custom command `/workflow:impl` を Grok skill として再現します。
