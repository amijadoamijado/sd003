---
name: bug-trace
description: "Bug Trace - 3-Agent parallel investigation for complex bugs (Use when the user runs /bug-trace.)"
---

# Bug Trace - 3-Agent Parallel Investigation v2.4

SD003 custom command `/bug-trace` を Grok skill として再現します。
