...
description: Codex equivalent of the SD003 custom command `/workflow:request`. Use when the user invokes `/workflow:request`, `workflow-request`.
---

# 実装指示作成: /workflow:request

この skill は Claude Code の `/workflow:request` を Codex で再現するためのものです。
