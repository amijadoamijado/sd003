...
description: "/sd003:loop-type - TypeScript Type-Check Loop (Use when the user runs /sd003-loop-type.)"
---

# /sd003:loop-type - TypeScript Type-Check Loop

SD003 custom command `/sd003:loop-type` を Grok skill として再現します。
