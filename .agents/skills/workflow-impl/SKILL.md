---
name: workflow-impl
description: Codex equivalent of the SD003 custom command `/workflow:impl`. Use when the user invokes `/workflow:impl`, `workflow-impl`.
---

# 実装実行: /workflow:impl

この skill は Claude Code の `/workflow:impl` を Codex で再現するためのものです。
