---
name: refactor-init
description: Codex equivalent of the SD003 custom command `/refactor:init`. Use when the user invokes `/refactor:init`, `refactor-init`.
---

# /refactor:init

この skill は Claude Code の `/refactor:init` を Codex で再現するためのものです。
