---
name: refactor-init
description: "Initialize refactoring session with parallel impact analysis (Use when the user runs /refactor-init.)"
---

# /refactor:init

SD003 custom command `/refactor:init` を Grok skill として再現します。
