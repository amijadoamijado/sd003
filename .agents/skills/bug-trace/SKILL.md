---
name: bug-trace
description: Codex equivalent of the SD003 custom command `/bug-trace`. Use when the user invokes `/bug-trace`, `bug-trace`.
---

# Bug Trace - 3-Agent Parallel Investigation v2.4

この skill は Claude Code の `/bug-trace` を Codex で再現するためのものです。
